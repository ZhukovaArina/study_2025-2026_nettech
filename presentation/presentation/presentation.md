...
### Роль в сетевых технологиях

- **Фундаментальное понятие** сетевых коммуникаций
- **Основа работы** Интернета и локальных сетей
- **Идентификация и локализация** устройств в сети

### Основные функции

- Уникальная идентификация сетевых узлов
- Правильная маршрутизация данных
- Организация сетевого пространства

### Эволюция стандартов

- **IPv4** - устоявшийся стандарт
- **IPv6** - перспективный преемник

**Цель**: Систематизация знаний о структуре и принципах IP-адресации
...
- **Best-effort** - максимальные усилия для доставки

###  Ключевые задачи

- Адресация сетевых узлов
- Маршрутизация между подсетями
- Фрагментация на датаграммы

### Взаимодействие с другими уровнями

- Надёжность обеспечивается TCP
